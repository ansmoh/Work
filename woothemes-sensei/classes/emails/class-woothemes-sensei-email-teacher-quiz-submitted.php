 ...
 */
     ...
     */
        function trigger($learner_id = 0, $quiz_id = 0)
        {
            ...
            $to  = $this->recipient . ', ';
            $to .= 'carolee@carealtytraining.com'.',';
            $to .= 'csm@carealtytraining.com';
            $to .= 'csa@carealtytraining.com';
            $to .= 'robert@carealtytraining.com';
            // Send mail
            $woothemes_sensei->emails->send($to, $this->subject, $woothemes_sensei->emails->get_content($this->template));
        }
    }
