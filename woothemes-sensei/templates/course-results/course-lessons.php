...
if ( is_user_logged_in() ) {
	...
	$html .= '<section class="course-results-lessons">';
		...
		$html .= '<h2 class="total-grade" style="display: none;">' . apply_filters( 'sensei_total_grade_text', __( 'Total Grade', 'woothemes-sensei' ) ) . '<span class="lesson-grade">' . $course_user_grade . '%</span></h2>';
