...
?>
	...
	<p class="sensei-login-username form-row form-row-wide">
				...
				<input type="text" name="log" id="sensei_user_login" class="input" value="" size="20" placeholder="Username or Email">
	</p>

	<p class="sensei-login-password form-row form-row-wide">
				<label for="sensei_user_pass"> <?php _e('Password','woothemes-sensei')?>  </label>
				<input type="password" name="pwd" id="sensei_user_pass" class="input txt text" value="" size="20" placeholder="Password">
	</p>
