		...
		<ul class="wc-deposits-option">
			<li>
				...
				<label for="wc-option-pay-full">
					<?php _e( 'Pay Today', 'woocommerce-deposits' ); ?>
				</label>
			</li>
           			<li>
				<input type="radio" name="wc_deposit_option" value="yes" class="test" id="wc-option-pay-deposit"/>
				<label for="wc-option-pay-deposit">
					<?php _e( 'Pay in Installments +25.00', 'woocommerce-deposits' ); ?>
				</label>
			</li> 
