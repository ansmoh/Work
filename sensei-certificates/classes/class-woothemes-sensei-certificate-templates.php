...
class WooThemes_Sensei_Certificate_Templates
{
    ...
    public function generate_pdf($path = '')
    {
        ...
        $certificate_registration_date = sprintf(__('At %s', 'sensei-certificates'), get_bloginfo('name')); // At {{course_place}}
        if (isset($this->certificate_template_fields['certificate_registration_date']['text']) && '' != $this->certificate_template_fields['certificate_registration_date']['text']) {
            $certificate_registration_date = $this->certificate_template_fields['certificate_registration_date']['text'];
            $certificate_registration_date = str_replace(array( '{{learner}}', '{{course_title}}', '{{completion_date}}', '{{course_place}}' ,'{{registration_date}}' ), array( $student_name, $course['post_title'], $date, get_bloginfo('name') ,$registered ), $certificate_registration_date);
        }
