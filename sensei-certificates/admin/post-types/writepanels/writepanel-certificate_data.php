...
function certificate_template_data_meta_box($post)
{
    ...
    global $woocommerce, $woothemes_sensei_certificate_templates,$current_user;
    ...
    <div id="certificate_options" class="panel certificate_templates_options_panel">
        <div class="options_group">
            <?php
            $student_rd = $current_user->user_registered;
            $rd_date = date("F j, Y", strtotime($student_rd));
                // Defaults
            ...
            //Sensei Registration Date
                    echo '<div class="options_group">';
                    certificate_templates_wp_position_picker(array(
                        'id'          => 'certificate_registration_date_pos',
                        'label'       => __('Registration Date Position', 'sensei-certificates'),
                        'value'       => implode(',', $woothemes_sensei_certificate_templates->get_field_position('certificate_registration_date')),
                        'description' => __('Optional position of the registration date.', 'sensei-certificates'),
                    ));
                    certificates_wp_hidden_input(array(
                        'id'    => '_certificate_registration_date_pos',
                        'class' => 'field_pos',
                        'value' => implode(',', $woothemes_sensei_certificate_templates->get_field_position('certificate_registration_date')),
                    ));
                    certificate_templates_wp_font_select(array(
                        'id'      => '_certificate_registration_date',
                        'label'   => __('Font', 'sensei-certificates'),
                        'options' => $available_fonts,
                    ));
                    certificates_wp_text_input(array(
                        'id'    => '_certificate_registration_date_font_color',
                        'label' => __('Font color', 'sensei-certificates'),
                        'value' => isset($woothemes_sensei_certificate_templates->certificate_template_fields['certificate_registration_date']['font']['color']) ? $woothemes_sensei_certificate_templates->certificate_template_fields['certificate_registration_date']['font']['color'] : '',
                        'class' => 'colorpick',
                    ));
                    certificates_wp_text_input(array(
                        'class'       => 'medium',
                        'id'          => '_certificate_registration_date_text',
                        'label'       => __('Registration Date Text', 'sensei-certificates'),
                        'description' => __('Text to display in the registration date area.', 'sensei-certificates'),
                        'placeholder' => __('{{registration_date}}', 'sensei-certificates'),
                        'value'       => isset($woothemes_sensei_certificate_templates->certificate_template_fields['certificate_registration_date']['text']) ? $woothemes_sensei_certificate_templates->certificate_template_fields['certificate_registration_date']['text'] : '',
                    ));
                    echo '</div>';
...
function certificate_templates_process_meta($post_id, $post)
{
    ...
    $fields = array();
    foreach (array( '_certificate_heading', '_certificate_message', '_certificate_course', '_certificate_completion', '_certificate_place','_certificate_registration_date' ) as $i => $field_name) {
